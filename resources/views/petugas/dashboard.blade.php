...
@section('title', 'Dashboard Petugas | ReadSpace')
...
<div class="p-8 md:p-10">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        <div>
            <div class="h-1 w-20 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full"></div>
            <h1
                class="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent pb-4">
                Dashboard Petugas
            </h1>
            <p class="text-gray-600">
                Kelola sirkulasi peminjaman dan buku perpustakaan
            </p>
        </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div
            ...
            <div class="relative">
                ...
                <p class="text-sm text-emerald-100 font-medium">Buku Terlambat</p>
            </div>
        </div>
