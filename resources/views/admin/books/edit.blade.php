...
@section('title', 'Edit Buku | Admin ReadSpace')
...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 ml-12">Perbarui informasi buku di perpustakaan</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                type="number" 
                                name="year"
                                value="{{ old('year', $book->tahun_terbit) }}"
                                placeholder="2024"
                                min="1900"
                                max="{{ date('Y') + 1 }}"
                                class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-200"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <span class="text-sm text-gray-600" id="file-name">Ganti cover (opsional)</span>
                                </label>
                            </div>
                            <p class="text-xs text-gray-500 mt-2">Format: JPG, PNG, WEBP (Max. 2MB)</p>
                            
                            {{-- Cover Preview --}}
                            <div id="cover-preview" class="mt-4 {{ $book->cover ? '' : 'hidden' }}">
                                <img 
                                    src="{{ $book->cover ? asset('images/books/'.$book->cover) : '' }}" 
                                    alt="Preview" 
                                    class="w-32 h-40 object-cover rounded-lg shadow-md border-2 border-gray-200"
                                >
                                @if($book->cover)
