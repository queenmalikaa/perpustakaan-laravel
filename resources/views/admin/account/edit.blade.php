...
@section('title', 'Edit Akun | Admin ReadSpace')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                <a 
                    href="{{ $user->role == 'user' ? route('account.pembaca') : route('account') }}" 
            ...
            <p class="text-gray-600 ml-12">Perbarui informasi akun pengguna</p>
        </div>

        <form 
            action="{{ route('account.update', $user->id) }}" 
            method="POST" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="user" {{ (old('role', $user->role) == 'user') ? 'selected' : '' }}>Pembaca (User)</option>
                            </select>
                        </div>
